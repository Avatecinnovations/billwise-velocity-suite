    ...
    <section className="py-20">
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h2 className="text-4xl font-bold mb-4">Integrates with 50+ applications</h2>
          <p className="text-xl text-gray-600">
            Connect InvoiceIQ with your favorite tools to streamline your workflow.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-8 gap-6">
          {integrationIcons.map((icon, index) => (
            ...
            >
              <span className="text-2xl font-bold text-gray-700">{icon.letter}</span>
            </div>
          ))}
        </div>
