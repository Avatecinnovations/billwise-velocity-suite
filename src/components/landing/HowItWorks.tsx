  ...
  const steps = [
    {
      ...
      description: "Easily track time spent on projects and automatically calculate expenses to include in your invoices.",
      imageRight: true,
      image: (
    ...
    },
    {
      ...
      description: "Create professional invoices in seconds with our customizable templates and send them directly to your clients.",
      imageRight: false,
      image: (
        <div className="bg-gray-100 rounded-lg p-4 h-full flex items-center justify-center overflow-hidden">
          <motion.div 
    ...
    },
    {
      ...
      description: "Get paid faster with multiple payment options including credit cards, PayPal, bank transfers, and more.",
      imageRight: true,
      image: (
        <div className="bg-gray-100 rounded-lg p-4 h-full flex items-center justify-center overflow-hidden">
          <motion.div 
      ...
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-gray-600">
            InvoiceIQ simplifies your invoicing workflow, from tracking time to getting paid.
          </p>
        </div>
