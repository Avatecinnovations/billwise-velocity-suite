        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div>
            <Link to="/" className="flex items-center mb-6">
              <span className="font-bold text-2xl">InvoiceIQ</span>
            </Link>
            <p className="text-gray-400 mb-6">
              Modern invoicing platform for freelancers and small businesses.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/guides" className="text-gray-400 hover:text-white">User Guides</Link></li>
